...
<head>
    ...
    <title>D and D Character Manager</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        <li>
                            <a href="{{ url('/login') }}"><img src="/image/mask.jpg" title = "Login" style="width:50px; height:50px; border-radius:50%; margin-right:25px;"></a>
                        </li>
                        <li>
